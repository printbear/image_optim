...
Gem::Specification.new do |s|
  s.name        = 'image_optim'
  s.version     = '0.10.2'
  s.summary     = %q{Optimize (lossless compress) images (jpeg, png, gif) using external utilities (advpng, gifsicle, jpegoptim, jpegtran, optipng, pngcrush, pngout, pngquant)}
